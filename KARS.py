...
class KARS:
    ...
    def keyword_extraction(self,UPOS_model, text_type):
        keyword_extraction_class = keyword_extraction(self.DB_path, UPOS_model=UPOS_model, text_type=text_type)
    ...
    def research_trend_analysis(self, keyword_limit=80, weight_limit=2, min_year=None, max_year=None, start_PLC='development', end_PLC='maturity', top_rank=30):
        research_trend_class = research_trend(self.DB_path, min_year, max_year)
        ...
        research_maturity_plot = research_trend_class.research_maturity()
